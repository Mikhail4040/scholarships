...
<nav class="navbar navbar-expand-sm bg-warning navbar-dark">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href='{{route("delete")}}'>Delete a scholarships</a></li>
...
<div class="container mt-3">
  <div class="mt-4 p-5 bg-primary text-white rounded">
    ...
    <p>Here you can Delete a scholarship..</p> 
  </div>
</div>
...
<table  class="table table-condensed" style="  border: 4px solid black; ">
  ...
  <th style=" background-color: orange;">id</th>
    <th style=" background-color: orange;">Scholarship Name</th>
    <th style=" background-color: orange;">University Name</th>
    <th style=" background-color: orange;">Study language</th>
    <th style=" background-color: orange;">Details</th>
  </tr>
